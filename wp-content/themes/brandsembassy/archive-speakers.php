    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="section--description d-block d-md-none"><?php echo __('С нами сотрудничают более 6000 экспертов – специалистов в различных отраслях', 'brandsembassy'); ?></div>
            </div>
            <div class="col-md-4">
                <?php
                    $placeholder = __('Search for experts', 'brandsembassy');
        ...
        <div class="posts-list">
            <div class="header-posts">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4 col-12">
                        <?php
                            $query = bre_get_filtered_types('speakers');
                            bre_the_founded_posts($query->found_posts, _n('%s expert', '%s experts', $query->found_posts, 'brandsembassy'));
                        ?>
                    </div>
                </div>
            </div>
            ...
            <?php if($query->have_posts() && $query->found_posts > 9) : ?>
                <?php bre_the_load_more_button('speakers')?>
            <?php endif;?>
        </div>
    </div>
