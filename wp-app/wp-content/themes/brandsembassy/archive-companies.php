    ...
    <div class="page-wrapper">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <?php
                        $placeholder = __('Search for companies', 'brandsembassy');
            ...
            <div class="header-posts">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4 col-12">
                        <?php
                            $query = bre_get_filtered_types('companies');
                            bre_the_founded_posts($query->found_posts, _n('%s company', '%s companies', $query->found_posts, 'brandsembassy'));
                        ?>
                    </div>
                </div>
            </div>
                ...
                <?php if($query->have_posts() && $query->found_posts > 9) : ?>
                    <?php bre_the_load_more_button('companies')?>
                <?php endif;?>
            </div>
        </div>
